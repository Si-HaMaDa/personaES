...
{!! Form::open(['url'=>aurl('/freelesson'),'id'=>'freelesson','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::text('v_url',old('v_url'),['class'=>'form-control','placeholder'=>trans('admin.v_url')]) !!}
    </div>
</div>
<br>
<div class="form-group">
