...
<div class="col-md-6">
	...
	<div class="form-group">
		...
		<div class="col-md-9">
				{!! Form::number('price',$course->price,['class'=>'form-control','placeholder'=>trans('admin.price')]) !!}
		</div>
		</div>
	</div>
		...
		<div class="col-md-9">
				{!! Form::number('sessions',$course->sessions,['class'=>'form-control','placeholder'=>trans('admin.sessions')]) !!}
		</div>
		</div>
	</div>
		<br>
		...
		<div class="col-md-9">
				{!! Form::number('duration_num',$course->duration_num,['class'=>'form-control','placeholder'=>trans('admin.duration_num')]) !!}
		</div>
		</div>
	</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
	{!! Form::select('duration_dis',['week'=>trans('admin.week'),'day'=>trans('admin.day')],$course->duration_dis,['class'=>'form-control']) !!}
			</div>
	</div>
	</div>
	<br>
		...
		<div class="col-md-9">
				{!! Form::number('attends',$course->attends,['class'=>'form-control','placeholder'=>trans('admin.attends')]) !!}
		</div>
		</div>
		<br>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
					{!! Form::text('strat_at',$course->strat_at,['class'=>'form-control date-time','placeholder'=>trans('admin.strat_at'),'readonly'=>'readonly','data-date'=>date("Y-m-d HH:ii:ss"),'data-date-format'=>'yyyy-mm-dd HH:ii:ss']) !!}
			</div>
	</div>
	<br>
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::text('time', $course->time ,['class'=>'form-control','placeholder'=>trans('admin.time')]) !!}
    </div>
</div>
<br>
