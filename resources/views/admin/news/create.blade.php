...
{!! Form::open(['url'=>aurl('/news'),'id'=>'news','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::textarea('subject',old('subject'),['class'=>'form-control','placeholder'=>trans('admin.subject')]) !!}
    </div>
</div>
<br>
<div class="form-group">
