...
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::textarea('features_workplace_des',old('features_workplace_des'),['class'=>'form-control ckeditor','placeholder'=>trans('admin.features_workplace_des')]) !!}
    </div>
</div>
<br>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::textarea('examine_memorable_des',old('examine_memorable_des'),['class'=>'form-control ckeditor','placeholder'=>trans('admin.examine_memorable_des')]) !!}
    </div>
</div>
<br>
