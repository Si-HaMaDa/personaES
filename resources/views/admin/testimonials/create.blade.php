...
{!! Form::open(['url'=>aurl('/testimonials'),'id'=>'testimonials','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::text('job',old('job'),['class'=>'form-control','placeholder'=>trans('admin.job')]) !!}
    </div>
</div>
<br>
<div class="form-group">
