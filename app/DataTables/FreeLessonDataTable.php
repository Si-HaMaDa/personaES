...
class FreeLessonDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.freelesson.buttons.actions')
    ...
    {
        return FreeLesson::query()->select("free_lessons.*");
