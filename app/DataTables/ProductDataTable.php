...
class ProductDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.product.buttons.actions')

            ->addColumn('img', 'admin.product.buttons.img')
            ->addColumn('Category', function ($query) {
                return $query->Category->name;
            })
            ->addColumn('features_workplace_img', 'admin.product.buttons.features_workplace_img')
            ...
            ->rawColumns(['checkbox','actions','img','features_workplace_img',]);
    }
    ...
    {
        return Product::query()->with(['Category',])->select("products.*");
	    ...
	    protected function getColumns()
	    {
            ...
            [
				...
				[
                 'name'=>'features_workplace_img',
                 'data'=>'features_workplace_img',
                 'title'=>trans('admin.features_workplace_img'),
                 'orderable'      => false,
                 'searchable'     => false,
                 'exportable'     => false,
                 'printable'      => false,
			...
			// 	[
            //      'name'=>'features_workplace_des',
            //      'data'=>'features_workplace_des',
            //      'title'=>trans('admin.features_workplace_des'),
		    // ],
			// 	[
            //      'name'=>'examine_memorable_pdf',
            //      'data'=>'examine_memorable_pdf',
            //      'title'=>trans('admin.examine_memorable_pdf'),
		    // ],
			// 	[
            //      'name'=>'examine_memorable_des',
            //      'data'=>'examine_memorable_des',
            //      'title'=>trans('admin.examine_memorable_des'),
		    // ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
