...
class ExpertsInDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.expertsin.buttons.actions')
            ->addColumn('photo', 'admin.expertsin.buttons.photo')
    ...
    {
        return ExpertsIn::query()->select("experts_ins.*");
