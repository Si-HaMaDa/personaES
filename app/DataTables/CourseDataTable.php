...
class CourseDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.course.buttons.actions')
            ->addColumn('photo', 'admin.course.buttons.photo')
            ->editColumn('clients', function($query)
                          {
                             return count($query->clients);
                          })
            // ->addColumn('duration_dis', '{{ trans("admin.".$duration_dis) }}')
	...
	public function query()
    {
        ...
        return Course::query()->select("courses.*")->with('Clients');
