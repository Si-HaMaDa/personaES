...
class OurClientsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.ourclients.buttons.actions')
            ->addColumn('logo', 'admin.ourclients.buttons.logo')
    ...
    {
        return OurClient::query()->select("our_clients.*");
